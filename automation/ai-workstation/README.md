...
- Q6-backed `default`, `qwen3-coder-128k`, or `qwen3-coder-256k`: use for full development/agent work where terminal, file, and code execution tools are expected.
