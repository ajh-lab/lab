...
function Write-Header {
  Clear-Host
  Write-Host "SPT01 Fika Server Manager" -ForegroundColor Cyan
  Write-Host "==========================" -ForegroundColor Cyan
  Write-Host ""
  Write-Host "This tool starts, stops, or restarts the SPT/Fika server setup on this VM."
  Write-Host "It controls:"
  Write-Host "  - SPT.Server.exe backend on https://192.168.1.85:6969"
