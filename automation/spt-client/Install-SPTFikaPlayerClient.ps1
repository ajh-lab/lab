...
$Script:Spt02ExpectedModItems = @(
  ...
  @{ Path = "SPT\user\mods\acidphantasm-progressiontracker"; Name = "Progression Tracker server mod" },
...
$Script:Spt02RequiredForgeDownloads = @(
  ...
  @{ Type = "mod"; Id = 2482; Name = "Progression Tracker"; Version = "1.0.3"; PageUrl = "https://forge.sp-tarkov.com/mod/2482/progression-tracker" },
