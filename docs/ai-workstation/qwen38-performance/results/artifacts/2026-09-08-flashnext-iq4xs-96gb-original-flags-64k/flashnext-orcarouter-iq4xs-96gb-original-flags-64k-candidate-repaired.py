...
def _parse_rfc3339_utc(s):
    ...
    # Validate RFC3339 format strictly: YYYY-MM-DDTHH:MM:SS(.ffffff)?(Z|+HH:MM|-HH:MM)
    # Python's fromisoformat in 3.11 accepts some non-RFC3339 formats, so we validate manually.
    import re
